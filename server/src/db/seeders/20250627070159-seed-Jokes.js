        ...
        const jokes = [
            {
                ...
                rightAns: 'Он просто привык — это часть дизайна',
                createdAt: new Date(),
                updatedAt: new Date(),
            },
            {
                ...
                rightAns: 'Когда в воздухе раздаётся тот самый звук',
                createdAt: new Date(),
                updatedAt: new Date(),
            },
            {
                ...
                rightAns: 'Они вдумчиво решают 2 часа — и это называется "повезло"',
                createdAt: new Date(),
                updatedAt: new Date(),
            },
            {
            ...
            },
            {
                ...
                rightAns: 'С двух ног, желательно с разворота',
                createdAt: new Date(),
                updatedAt: new Date(),
            },
            {
                ...
                rightAns: 'Сломалось — а ты ничего не трогал',
                createdAt: new Date(),
                updatedAt: new Date(),
            },
            {
                ...
                rightAns: 'Каждый день — новая серия боли',
                createdAt: new Date(),
                updatedAt: new Date(),
            },
        ];
